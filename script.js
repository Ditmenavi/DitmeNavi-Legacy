// const deadline = '2022-07-07T07:30';
...
// $("#wibuacc").on('inview', function(event, isInView) {
// 	if (isInView) {
// 		console.log("wibu is in view");
// 	} else {
// 		console.log("wibu is gone");
// 	}
//   });
// $viewport = $('#viewport');

// $(window).scroll(function() {
// 	// $("#wibuacc").css('background-color', 'red');
// 	// $("#wibuacc").isInViewport({ viewport: $viewport }).css('background-color', '#C5C7BC');
